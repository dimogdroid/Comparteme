...
public class SocialNetworkSpinnerAdapter extends ArrayAdapter<SocialNetwork>
{
    ...
    public SocialNetworkSpinnerAdapter(Context context, List<SocialNetwork> datos)
    {
        ...
        super(context, R.layout.spiner_selected_item, datos);
    ...
    public View getView(int position, View convertView, ViewGroup parent)
    {
        if (convertView == null)
        {
            convertView = ((LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE)).inflate(R.layout.spiner_selected_item,null);
        }
